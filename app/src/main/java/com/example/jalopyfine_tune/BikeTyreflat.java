...
public class BikeTyreFlat extends FragmentActivity implements OnMapReadyCallback {
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!workerFound && requestBol) {
                    ...
                    final DatabaseReference workerRef = FirebaseDatabase.getInstance().getReference().child("Workers").child("Bike").child("Tyre Flat").child(workerFoundID);
    ...
    private void getWorkerInfo() {
        DatabaseReference mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Workers").child("Bike").child("Tyre Flat").child(workerFoundID);
    ...
    private void getHasWorkEnded() {
        workHasEndedRef = FirebaseDatabase.getInstance().getReference().child("Workers").child("Bike").child("Tyre Flat").child(workerFoundID).child("CustomerStatusId");
    ...
    private void showRatingDialog(final String key) {
        ...
        mRateWorker.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean b) {
                ...
                Intent intent = new Intent(BikeTyreFlat.this, HistorySingleObject.class);
    ...
    private void endWork() {
        ...
        if (workerFoundID != null) {
            DatabaseReference workerRef = FirebaseDatabase.getInstance().getReference().child("Workers").child("Bike").child("Tyre Flat").child(workerFoundID).child("CustomerStatusId");

...
public class CarTyreFlat extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference ref = FirebaseDatabase.getInstance().getReference("customerRequest").child("Car").child("Tyre Flat");
    ...
    private void getClosestWorker() {
        DatabaseReference workerAvailable = FirebaseDatabase.getInstance().getReference().child("workerAvailable").child("Car").child("Tyre Flat");
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!workerFound && requestBol) {
                    ...
                    final DatabaseReference workerRef = FirebaseDatabase.getInstance().getReference().child("Workers").child("Car").child("Tyre Flat").child(workerFoundID);
    ...
    private void getWorkerInfo() {
        DatabaseReference mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Workers").child("Car").child("Tyre Flat").child(workerFoundID);
    ...
    private void getHasWorkEnded() {
        workHasEndedRef = FirebaseDatabase.getInstance().getReference().child("Workers").child("Car").child("Tyre Flat").child(workerFoundID).child("CustomerStatusId");
    ...
    private void showRatingDialog(final String key) {
        ...
        mRateWorker.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean b) {
                ...
                Intent intent = new Intent(CarTyreFlat.this, HistorySingleObject.class);
    ...
    private void endWork() {
        ...
        if (workerFoundID != null) {
            DatabaseReference workerRef = FirebaseDatabase.getInstance().getReference().child("Workers").child("Car").child("Tyre Flat").child(workerFoundID).child("CustomerStatusId");
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(CarTyreFlat.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create();
                dialog.show();
